 ...
 * {@link com.google.gson.GsonBuilder}: <pre>   {@code
 *
...
public abstract class TypeAdapter<T> {
   ...
   * Unlike Gson's similar {@link com.google.gson.Gson#toJson(com.google.gson.JsonElement, Appendable) toJson}
   ...
   * similar {@link com.google.gson.Gson#fromJson(String, Class) fromJson} method, this read is
