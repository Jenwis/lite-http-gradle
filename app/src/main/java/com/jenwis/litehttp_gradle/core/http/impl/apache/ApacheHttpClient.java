package com.jenwis.litehttp_gradle.core.http.impl.apache;
...
import com.jenwis.litehttp_gradle.core.http.data.Charsets;
...
import com.jenwis.litehttp_gradle.core.http.listener.HttpListener;
import com.jenwis.litehttp_gradle.core.http.parser.DataParser;
import com.jenwis.litehttp_gradle.core.http.parser.StringParser;
import com.jenwis.litehttp_gradle.core.http.request.Request;
import com.jenwis.litehttp_gradle.core.http.request.content.HttpBody;
...
import com.jenwis.litehttp_gradle.core.http.response.InternalResponse;
...
public class ApacheHttpClient extends LiteHttpClient {
    ...
    /**
     * new {@link org.apache.http.impl.client.DefaultHttpClient}, and set strategy.
     *
     * @param httpParams
    ...
    @Override
    public com.jenwis.litehttp_gradle.core.http.data.NameValuePair[] head(String uri) {
        ...
        while (retry) {
            try {
                ...
                if (!Thread.currentThread().isInterrupted()) {
                    ...
                    if (headers != null) {
                        com.jenwis.litehttp_gradle.core.http.data.NameValuePair hs[] = new com.jenwis.litehttp_gradle.core.http.data.NameValuePair[headers.length];
                        for (int i = 0; i < headers.length; i++) {
                            ...
                            hs[i] = new com.jenwis.litehttp_gradle.core.http.data.NameValuePair(name, value);
                        }
