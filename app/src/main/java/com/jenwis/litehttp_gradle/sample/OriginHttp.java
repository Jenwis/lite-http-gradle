...
public class OriginHttp {
	...
	public static ExtendBasedModel.User parseJsonToUser(String json) {
		ExtendBasedModel.User user = new ExtendBasedModel.User();
		if (json != null) {
			try {
				...
				user.result = new ExtendBasedModel.User.Result();
				user.data = new ExtendBasedModel.User.UserInfo();
