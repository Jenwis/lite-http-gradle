package com.jenwis.litehttp_gradle.sample;
...
import com.jenwis.litehttp_gradle.R;
import com.jenwis.litehttp_gradle.core.android.async.AsyncExecutor;
import com.jenwis.litehttp_gradle.core.android.log.Log;
import com.jenwis.litehttp_gradle.core.http.LiteHttpClient;
import com.jenwis.litehttp_gradle.core.http.async.HttpAsyncExecutor;
...
import com.jenwis.litehttp_gradle.core.http.exception.HttpClientException;
import com.jenwis.litehttp_gradle.core.http.exception.HttpClientException.ClientException;
import com.jenwis.litehttp_gradle.core.http.exception.HttpException;
import com.jenwis.litehttp_gradle.core.http.exception.HttpNetException;
import com.jenwis.litehttp_gradle.core.http.exception.HttpNetException.NetException;
import com.jenwis.litehttp_gradle.core.http.exception.HttpServerException;
import com.jenwis.litehttp_gradle.core.http.exception.HttpServerException.ServerException;
import com.jenwis.litehttp_gradle.core.http.parser.BinaryParser;
import com.jenwis.litehttp_gradle.core.http.parser.BitmapParser;
import com.jenwis.litehttp_gradle.core.http.parser.DataParser;
import com.jenwis.litehttp_gradle.core.http.parser.FileParser;
import com.jenwis.litehttp_gradle.core.http.request.Request;
import com.jenwis.litehttp_gradle.core.http.request.content.*;
import com.jenwis.litehttp_gradle.core.http.request.content.multi.BytesPart;
import com.jenwis.litehttp_gradle.core.http.request.content.multi.FilePart;
import com.jenwis.litehttp_gradle.core.http.request.content.multi.InputStreamPart;
import com.jenwis.litehttp_gradle.core.http.request.content.multi.StringPart;
import com.jenwis.litehttp_gradle.core.http.request.param.HttpMethod;
import com.jenwis.litehttp_gradle.core.http.request.param.HttpParam;
import com.jenwis.litehttp_gradle.core.http.response.Response;
import com.jenwis.litehttp_gradle.core.http.response.handler.HttpExceptionHandler;
import com.jenwis.litehttp_gradle.core.http.response.handler.HttpModelHandler;
import com.jenwis.litehttp_gradle.core.http.response.handler.HttpResponseHandler;
import com.jenwis.litehttp_gradle.sample.model.param.RequestParams;
import com.jenwis.litehttp_gradle.sample.model.response.CompositeBasedModel;
import com.jenwis.litehttp_gradle.sample.model.response.ExtendBasedModel;
...
public class LiteHttpSamplesActivity extends BaseActivity {
    ...
    /**
     * 在{@link BaseActivity#onCreate(android.os.Bundle)}中设置视图
     */
    @Override
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                switch (which) {
                    ...
                    case 1:
                        ...
                        break;
                    case 2:
                        req.setHttpBody(new JsonBody(new RequestParams.BaiDuSearch()));
                        break;
                    case 3:
    ...
    private void innerAsyncGetModel() {
        ...
        asyncExcutor.execute(new Request(urlUser), new HttpModelHandler<ExtendBasedModel.User>() {
            @Override
            protected void onSuccess(ExtendBasedModel.User data, Response res) {
                Log.i(TAG, "User: " + data);
                toast("User: " + data);
                printLog(res);
            }
        ...
        asyncExcutor.execute(new Request(urlUserList), new HttpModelHandler<ArrayList<ExtendBasedModel.User>>() {
            @Override
            protected void onSuccess(ArrayList<ExtendBasedModel.User> data, Response res) {
    ...
    private void makeJavaModeAsParamsRequest() {
        RequestParams.BaiDuSearch model = new RequestParams.BaiDuSearch();
    ...
    private void makeIntelligentJsonModelMapingRequest() {
        ...
        asyncExcutor.execute(new AsyncExecutor.Worker<Response>() {
            ...
            public void onPostExecute(Response res) {
                //以组合的方式组织model并解析
                CompositeBasedModel.ApiResult api = res.getObject(CompositeBasedModel.ApiResult.class);
                if (api != null) {
                    CompositeBasedModel.UserModel user1 = api.getData(CompositeBasedModel.UserModel.class);
                    Log.i(TAG, "user1: " + user1);
                    toast("user1: " + user1);
                }
                //以继承的方式组织model并解析
                ExtendBasedModel.User user2 = res.getObject(ExtendBasedModel.User.class);
